...
InputDecoration inputDecoration(BuildContext context, {Widget? suffixIcon, Widget? prefixIcon, String? labelText, double? borderRadius}) {
  return InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: radius(borderRadius ?? defaultRadius),
      borderSide: BorderSide(color: rf_primaryColor, width: 0.0),
    ),
    filled: true,
  ...
  return Column(
    children: [
      Container(
        ...
        decoration: boxDecorationWithRoundedCorners(boxShape: BoxShape.circle, backgroundColor: rf_primaryColor),
...
Widget settingIconWidget({IconData? icon}) {
  return Container(
    ...
    decoration: BoxDecoration(color: rf_primaryColor, shape: BoxShape.circle),
